...
<body>
  <?php
    require_once 'connection.php';    //Загружаем настройки 
    $sth = $pdo->prepare("SELECT * FROM users");  //Все данные из таблицы users
    ...
    <div class="row">
      ...
      <div class="col-md-8">     
        ...
        <caption> Список пользователей </caption>
          ...
          <tbody>
            <?php while ($row = $sth->fetch(PDO::FETCH_LAZY)): // цикл по коллекции строк из БД?>
            <?php if ($row['del'] != 1): ?>
